...
const editTask = (index) => {
  ...
  deleteTask(index); // सीधे deleteTask() कॉल कर दिया
};
  ...
  tasks.forEach((task, index) => {
    ...
    listItem.innerHTML = `
      <div class="taskItem">
        ...
        <div class="icons">
          <img src="./img/edit.png" class="edit-task" data-index="${index}" />
          <img src="./img/bin.png" class="delete-task" data-index="${index}" />
        </div>
      </div>
    `;
